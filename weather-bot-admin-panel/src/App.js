...
function App() {
  ...
  return (
    <Container maxWidth="md" style={{ textAlign: 'center', marginTop: '20px'}}>
      <Typography variant="h4" gutterBottom>Admin Panel - Weather Bot</Typography>
      ...
      {/* Footer */}
      <Typography variant="body2" style={{ marginTop: '20px' , fontSize: '20px' }}>
        <Link href="https://t.me/Weather_AutoBot" target="_blank" rel="noopener noreferrer">Click Here To Access Your Bot</Link>
        
      </Typography>
      <p>
      Created By{' '}
      <div col style={{ color: 'blue' }}>
        <a
          href="https://www.linkedin.com/in/syed-faraaz-ali-446767175/"
          target="_blank"
